...
public class FakeLight : MonoBehaviour
{
   ...
   public GameObject player;
    ...
    void Start()
    {
        ...
        cam.fieldOfView = GetComponent<Light>().spotAngle / 2;
        player = GameObject.Find("FakePlayer");
    }
    ...
    void FireCheck()
    {
        ...
        if (viewPos.z > 0 && viewPos.x > 0 && viewPos.x < 1 && viewPos.y > 0 && viewPos.y < 1)
        {
            ...
            //{
            //    gameObject.transform.GetChild(0).LookAt(player.transform.position + new Vector3(0, 0.4f, 0));
            //}
            //else
            {
